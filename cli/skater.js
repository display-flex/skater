...
program.command('put <file|dir...>')
    ...
    .on('--help', function() {
        ...
        console.log();
        console.log('    $ skater put file.txt /                # puts to /file.txt');
        console.log('    $ skater put file.txt /data            # puts to /data/file.txt');
        console.log('    $ skater put dir /data                 # puts dir/* as /data/dir/*');
        console.log('    $ skater put dir/. /                   # puts dir/* as /app/data/*');
        console.log('    $ skater put dir1 dir2 file1 /         # puts as /dir1/* /dir2/* and /file');
        console.log();
    });
